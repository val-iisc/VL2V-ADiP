...
class Job:
    ...
    def __init__(self, train_args, sweep_output_dir):
        ...
        command = ["python", "train_all.py", '"expt"']
        ...
        for dataset in dataset_names:
            for algorithm in algorithms:
                ...
                for hparams_seed in range(n_hparams_from, n_hparams):
                    ...
                    train_args["sweep"] = "True"
                    train_args["swad"] = True
                    train_args["hpt_st"] = hpt_st
                    train_args["miro_swad"] = miro_swad
                    train_args["model_save"] = 100
                    train_args["pretrained"] = pretrained
                    train_args["backbone"] = backbone
                    train_args["seed"] = misc.seed_hash(
                        dataset, algorithm, hparams_seed, trial_seed
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu_id", default=0, help="CUDA GPU ID")
    ...
    parser.add_argument("--miro_swad", type=str, default=None)
    ...
    # for job_obj in jobs:
    #     print("Execution command:", job_obj.command_str)
    # exit()
